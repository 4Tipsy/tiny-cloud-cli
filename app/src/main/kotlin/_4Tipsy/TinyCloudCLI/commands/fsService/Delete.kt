...
class Delete : CliktCommand(help = "Deletes target entity") {
  ...
  override fun run() {
    runBlocking {
      ...
      val targetUrl = Config().main.apiRawUrl + "/fs-service/delete-entity"
      ...
      if (response.status.isSuccess()) {
        ...
        println( green("Ok [${brightWhite("200")}]: ") + "deleted '$name' (at '$where')" )
      }
